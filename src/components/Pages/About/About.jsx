...
import { FaReact, FaGithub, FaShoppingCart } from "react-icons/fa";
    ...
    <div className="min-h-screen bg-green-200 text-gray-800">
      ...
      <section className="bg-green-200 py-16">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <p className="text-xl font-semibold">Harshal Paitl</p>
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-green-600 text-white px-6 py-3 rounded-full shadow-md hover:bg-green-700 transition duration-300"
          >
            <FaGithub />
            Visit GitHub
          </a>
      ...
      <section className="text-center px-6 py-20 bg-green-200">
        ...
        <p className="max-w-2xl mx-auto text-gray-700 text-lg leading-relaxed">
          I aim to continue strengthening my development skills and secure a
          position in a reputable company where I can contribute to impactful
